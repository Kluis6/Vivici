...
const sheetVariants = cva(
  "fixed z-50 flex h-full flex-col gap-4 border bg-popover p-6 text-sm text-popover-foreground shadow-xl outline-none duration-150 data-open:animate-in data-closed:animate-out",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 h-auto border-b data-open:slide-in-from-top data-closed:slide-out-to-top",
        right:
          "inset-y-0 right-0 w-full border-l data-open:slide-in-from-right data-closed:slide-out-to-right sm:max-w-md",
        bottom:
          "inset-x-0 bottom-0 h-auto border-t data-open:slide-in-from-bottom data-closed:slide-out-to-bottom",
        left: "inset-y-0 left-0 w-full border-r data-open:slide-in-from-left data-closed:slide-out-to-left sm:max-w-md",
      },
    },
    defaultVariants: {
      side: "right",
